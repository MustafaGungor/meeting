...
import DepartmentModel from "./model/DepartmentModel.json";

export default class Department extends ShallowComponent {
    ...
    constructor(props) {
        ...
        let store = new Store({
            ...
            idField: Department.idField,
            autoLoad: true
        });

        this.state = {
            fields: DepartmentModel.fields,
            store: store,
            showModal: false,
            item: {},
            propsOfFields: {
